...
for i = 1:numel(PU_i)
    ...
    gc1(i,:) = norm_jump(gcamp1(PU_i(i),:), [events 1900:50:2150], FPS, event_nan, windowSize1, smoothe_trace);
    gc2(i,:) = norm_jump(gcamp2(PU_i(i),:), [events 1900:50:2150], FPS, event_nan, windowSize1, smoothe_trace);    
end
gc1 = gc1(:,12001:end);
gc2 = gc2(:,12001:end);
